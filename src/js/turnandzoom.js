var custom_scrollbar = {
	...
	create: function(id, options, styles) {
		...
		options = jQuery.extend({
			...
			vertical: true,
			onScroll: function() {} // anonymous, do nothing by default
		}, options);
		...
		elements = { regress_arrow: null, slider: null, progress_arrow: null };
		for (e in elements) {
			if (elements.hasOwnProperty(e)) {
				elements[e] = document.getElementById(id + '_' + e);
				elements[e].onselectstart = function() {return false;} // thank you, IE, may I have another?
			}
		}
